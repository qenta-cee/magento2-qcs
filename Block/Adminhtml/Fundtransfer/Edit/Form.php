...
namespace Qenta\CheckoutSeamless\Block\Adminhtml\Fundtransfer\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldNoteFmt = sprintf('<a href="https://guides.wirecard.at/doku.php%%s" target="_blank" class="docref">%s</a>',
        ...
        $dataObject = $this->_backendSession->getQentaCheckoutSeamlessFundTransferFormData();
