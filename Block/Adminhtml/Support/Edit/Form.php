...
namespace Qenta\CheckoutSeamless\Block\Adminhtml\Support\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('to', 'select', [
            ...
            'name'     => 'to',
            'options'  => array(
                'support.at@wirecard.com' => 'Support Team Qenta CEE, Austria',
                'support@wirecard.com'    => 'Support Team Qenta AG, Germany',
                'support.sg@wirecard.com' => 'Support Team Qenta Singapore'
            )
        ]);
