...
namespace Qenta\CheckoutSeamless\Block\Adminhtml;
...
class Buttons extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $url = $this->getUrl('qentacheckoutseamless/test/config');
        ...
        $url = $this->getUrl('qentacheckoutseamless/support/contact');
        $html .= $this->getLayout()->createBlock('Magento\Backend\Block\Widget\Button')
                      ->setType('button')
                      ->setClass('scalable')
        ...
        $url = $this->getUrl('qentacheckoutseamless/fundtransfer/transfer');
        $html .= $this->getLayout()->createBlock('Magento\Backend\Block\Widget\Button')
                      ->setType('button')
                      ->setClass('scalable')
