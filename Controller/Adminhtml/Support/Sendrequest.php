...
namespace Wirecard\CheckoutSeamless\Controller\Adminhtml\Support;
...
class Sendrequest extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Wirecard\CheckoutSeamless\Model\Support
     */
    ...
    public function __construct(
        Context $context,
        \Wirecard\CheckoutSeamless\Model\Support $supportModel,
    ...
    {
        $redirectUrl = $this->getUrl('wirecardcheckoutseamless/support/contact');
