...
namespace Qenta\CheckoutSeamless\Controller\Adminhtml\Support;
...
class Sendrequest extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Qenta\CheckoutSeamless\Model\Support
     */
    ...
    public function __construct(
        Context $context,
        \Qenta\CheckoutSeamless\Model\Support $supportModel,
    ...
    {
        $redirectUrl = $this->getUrl('qentacheckoutseamless/support/contact');
