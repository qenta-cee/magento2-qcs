...
define(
    [
        ...
        'Qenta_CheckoutSeamless/js/model/min-age-validator',
        'mage/url',
        'jquery',
        'mage/translate',
    ...
    function (Component, setPaymentMethodAction, minAgeValidator, url, $, $t, additionalValidators) {
        return Component.extend({
            ...
            customerDob: null,
            defaults: {
                template: 'Qenta_CheckoutSeamless/payment/method-invoiceinstallment'
            },
            ...
            isB2B: function() {
                return this.getCode() == 'qenta_checkoutseamless_invoiceb2b';
            },
            validate: function () {
