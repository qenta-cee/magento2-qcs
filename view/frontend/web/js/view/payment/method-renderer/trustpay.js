...
define(
    ...
    function (Component, setPaymentMethodAction, url, $, additionalValidators) {
        return Component.extend({
            defaults: {
                template: 'Qenta_CheckoutSeamless/payment/method-trustpay'
            },
            ...
            hasFinancialInstitutions: function () {
                return window.checkoutConfig.payment[this.getCode()].financialinstitutions.length > 1;
            },
